...
# Version: 1.1
# Edit: Injected new Fullbox command
# Date: 30/01/2017
# Developer: fuji97
################################################################################
...
=end
	...
	# Edit by Fuji
	def command_102
    command = pbNewChoice(Fullbox_Option.createFromArray(@list[@index].parameters[0]),@list[@index].parameters[1])
    @branch[@list[@index].indent] = command
    Input.update # Must call Input.update again to avoid extra triggers
    return true
  end
